...
- API version: 1.16.0-dev
- Package version: 1.16.0-dev
...
*DefaultApi* | [**describe_balloon_hinting**](docs/DefaultApi.md#describe_balloon_hinting) | **GET** /balloon/hinting/status | Returns the balloon hinting statistics, only if enabled pre-boot.
...
*DefaultApi* | [**get_memory_hotplug**](docs/DefaultApi.md#get_memory_hotplug) | **GET** /hotplug/memory | Retrieves the status of the hotpluggable memory
...
*DefaultApi* | [**patch_memory_hotplug**](docs/DefaultApi.md#patch_memory_hotplug) | **PATCH** /hotplug/memory | Updates the size of the hotpluggable memory region
...
*DefaultApi* | [**put_guest_pmem_by_id**](docs/DefaultApi.md#put_guest_pmem_by_id) | **PUT** /pmem/{id} | Creates or updates a pmem device. Pre-boot only.
...
*DefaultApi* | [**put_memory_hotplug**](docs/DefaultApi.md#put_memory_hotplug) | **PUT** /hotplug/memory | Configures the hotpluggable memory
...
*DefaultApi* | [**put_serial_device**](docs/DefaultApi.md#put_serial_device) | **PUT** /serial | Configures the serial console
*DefaultApi* | [**start_balloon_hinting**](docs/DefaultApi.md#start_balloon_hinting) | **PATCH** /balloon/hinting/start | Starts a free page hinting run only if enabled pre-boot.
*DefaultApi* | [**stop_balloon_hinting**](docs/DefaultApi.md#stop_balloon_hinting) | **PATCH** /balloon/hinting/stop | Stops a free page hinting run only if enabled pre-boot.
